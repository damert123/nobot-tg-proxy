...
//        $this->setReportPeers(406210384);
        ...
        if ($message) {
            ...
            $responseGetTask = Http::asForm()->post('https://testservice444.planfix.ru/webchat/api', $dataGetTask);
...
//                    Log::channel('tg-messages')->info("Информация о медиа:" . json_encode($media, JSON_PRETTY_PRINT | JSON_UNESCAPED_UNICODE));
            ...
            try {
                ...
                $response = Http::asForm()->post('https://testservice444.planfix.ru/webchat/api', $data);
